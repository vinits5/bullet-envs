...
def params(argv=None):
	...
	parser.add_argument('--num_envs', type=int, default=1, help='Number of environments for distributed synchronous PPO')
	...
	parser.add_argument('--discrete', type=bool, default=False, help='Discrete or Continuous Environment.')
